...
average_reflectance = mean(reflectance_band(:));
...
for i = 6:bands-56
    ...
    average_reflectance_all_bands(i) = mean(reflectance_band(:));  % Compute the average reflectance for the band
end
...
reflectance_pixel = squeeze(reflectance(row, column, :));  % Extract the spectral profile
